...
!function(a) {
    var b = {
        init: function(b) {
            var d = {
              ...
              , e = a.extend(d, b);
            if (-1 !== e.minSize && -1 !== e.maxSize)
                throw new Error("Kwicks options minSize and maxSize may not both be set");
            if (e.behavior && "menu" !== e.behavior && "slideshow" !== e.behavior)
                throw new Error("Unrecognized Kwicks behavior specified: " + e.behavior);
        ...
        expand: function(b, c) {
            ...
            return this.each(function() {
                ...
                g && (e.$container.removeData("kwicks-timeout-id"),
                clearTimeout(g)),
                d > 0 ? e.$container.data("kwicks-timeout-id", setTimeout(f, d)) : f()
            })
        },
        expanded: function() {
            var a = this.first().data("kwicks");
            if (a)
                return a.expandedIndex
        },
        select: function(b) {
            return this.each(function() {
                var c = a(this)
    ...
    a.fn.kwicks = function(a) {
        ...
        if ("object" != typeof a && a)
            throw new Error("Unrecognized kwicks method: " + a);
    ...
    var c = function(b, c) {
        ...
        a.each(f, function(a) {
            d.$container.hasClass(a) || (d.$container.addClass(a),
        ...
        this.primaryDimension = c.isVertical ? "height" : "width",
        this.secondaryDimension = c.isVertical ? "width" : "height",
        this.calculatePanelSizes(),
        this.primaryAlignment = c.isVertical ? "top" : "left",
        this.secondaryAlignment = c.isVertical ? "bottom" : "right",
        this.$timer = a({
            progress: 0
        }),
        this.isAnimated = !1,
    ...
    c.prototype.calculatePanelSizes = function() {
        ...
        var c = this.$panels.length
          ...
          , e = b - d;
        this.panelSize = e / c,
        -1 === a.minSize ? (this.panelMaxSize = -1 === a.maxSize ? 5 > c ? 2 * (b / 3) : b / 3 : "%" === a.maxSizeUnits ? e * a.maxSize : a.maxSize,
        this.panelMinSize = (e - this.panelMaxSize) / (c - 1)) : -1 === a.maxSize && (this.panelMinSize = "%" === a.minSizeUnits ? e * a.minSize : a.minSize,
        this.panelMaxSize = e - this.panelMinSize * (c - 1))
    }
    ,
    c.prototype.getOffsetsForExpanded = function() {
        for (var a = this.expandedIndex, b = this.$panels.length, c = this.panelSpacing, d = this.panelSize, e = this.panelMinSize, f = this.panelMaxSize, g = [0], h = 1; b > h; h++)
            g[h] = -1 === a ? h * (d + c) : a >= h ? h * (e + c) : f + e * (h - 1) + h * c;
        return g
    }
    ,
    ...
    c.prototype.updatePanelStyles = function() {
        for (var a, b, c, d, e = this.offsets, f = this.$panels, g = this.primaryDimension, h = this.primaryAlignment, i = this.secondaryAlignment, j = this.panelSpacing, k = this.getContainerSize(), l = this._stylesInited ? "" : "position:absolute;", m = f.length; m--; )
            c = a,
            a = Math.round(e[m]),
            m === f.length - 1 ? (b = k - a,
            d = i + ":0;" + g + ":" + b + "px;") : (b = c - a - j,
            d = h + ":" + a + "px;" + g + ":" + b + "px;"),
            this.setStyle(f[m], l + d);
    ...
    c.prototype.initSlideshowBehavior = function() {
        var b, c = this, d = this.$panels.length, e = 0, f = !1, g = function() {
        ...
        g(),
        this.onDestroy(h),
        this.opts.interactive && (this.addEventHandler(this.$container, "mouseenter", h),
        this.addEventHandler(this.$container, "mouseleave", g),
        this.addEventHandler(this.$panels, "mouseenter", function() {
    ...
    c.prototype.getContainerSize = function(a) {
        ...
        return (a || !b) && (b = this._containerSize = this.$container[this.primaryDimension]()),
        b
    }
    ,
    ...
    c.prototype.destroy = function() {
        this.$timer.stop();
        for (var a = 0, b = this.onDestroyHandlers.length; b > a; a++)
            this.onDestroyHandlers[a]();
    ...
    c.prototype.select = function(b) {
        b !== this.selectedIndex && (a(this.getSelectedPanel()).removeClass("kwicks-selected"),
        this.selectedIndex = b,
        a(this.getSelectedPanel()).addClass("kwicks-selected"))
    }
    ,
    c.prototype.expand = function(b) {
        ...
        if (-1 === b && (b = this.selectedIndex),
        b !== this.expandedIndex) {
            a(this.getExpandedPanel()).removeClass("kwicks-expanded"),
            a(this.getCollapsedPanels()).removeClass("kwicks-collapsed"),
            this.expandedIndex = b,
            a(this.getExpandedPanel()).addClass("kwicks-expanded"),
            a(this.getCollapsedPanels()).addClass("kwicks-collapsed");
            var f = this.$timer
            ...
            f.animate({
                ...
                step: function(a) {
                    c._dirtyOffsets && (i = c.offsets,
                    j = c.getOffsetsForExpanded(),
                    c._dirtyOffsets = !1),
                    i.length = 0;
                    for (var b = 0; g > b; b++) {
                        var d = j[b]
                ...
                complete: function() {
                    c.isAnimated = !1,
                    c.$container.trigger("expand-complete.kwicks", {
                        index: b,
